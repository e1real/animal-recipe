...
collect_static:
	docker-compose exec django pipenv run ./manage.py collectstatic

# Manage the Django database
make_migrations:
	docker-compose exec django pipenv run ./manage.py makemigrations

migrate:
	docker-compose exec django pipenv run ./manage.py migrate

create_superuser:
	docker-compose exec django pipenv run ./manage.py createsuperuser